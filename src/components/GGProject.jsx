...
const GGProject = ({getGraphic, projectTwoElementsRef, showProjectTwo}) => {
  ...
  return (
    <>
      ...
      />
      <div className="project-two flex gap-7 flex-col relative pointer-events-none">
      ...
      <section id="RESEARCH" className="scroll-mt-15" ref={el => {
        ...
        <div className="flex flex-col gap-3 md:gap-5 " >
          <div className="flex flex-col gap-2">
            <p className=" mt-8 lg:mt-14 text-xs sm:text-sm">RESEARCH</p>
            <p className=" font-serif sm:text-xl lg:text-2xl xl:text-3xl xl:w-[70%]">Understanding what our product would be used for, who it will serve, and the opportunities it may bring for the club.</p>
          </div>
          <div className="flex flex-col gap-6">
            ...
            <img src={getGraphic("key_users")} className="xl:w-[80%] h-auto" alt="Four key user personas for Gator Gaming website" />
            <p className=" font-serif mt-2 sm:text-xl lg:text-2xl xl:text-3xl xl:w-[80%]">Next, we defined what constitutes a successful design in our case.</p>
            ...
            <img src={getGraphic("notes")} className="xl:w-[80%] h-auto" alt="Research notes on current website failures" />
            ...
            <img src={getGraphic("comp_analysis")} className="xl:w-[80%] h-auto" alt="Competitive analysis of similar club websites" />
            <img src={getGraphic("gaps")} className="xl:w-[80%] h-auto" alt="Identified gaps and opportunities in competitive analysis" />
            ...
            <div className='flex justify-center xl:w-[80%]'>
              <img src={getGraphic("survey_insights")} className="xl:w-[85%] h-auto" alt="Three major insights from member survey results" />
            </div>
            ...
            <div className='flex justify-center xl:w-[80%]'>
              <img src={getGraphic("requirements")} className="xl:w-[90%] h-auto" alt="Three core goals with actionable objectives for redesign" />
            </div>
      ...
      <section id="DESIGN" className="scroll-mt-15" ref={el => {
        ...
        <div className="flex flex-col gap-3 md:gap-5">
          <div className='flex flex-col gap-2'>
            <p className=" mt-8 lg:mt-14 text-xs sm:text-sm">DESIGN</p>
            <p className="font-serif sm:text-xl lg:text-2xl xl:text-3xl xl:w-[80%]">Finding frictionless ways for users to get to what they need.</p>
          </div>
          <div className="flex flex-col gap-6">
            ...
            <div className="flex justify-center xl:w-[80%]">
              <img src={getGraphic("sitemap")} className="xl:w-[90%] h-auto" alt="Conceptual sitemap for Gator Gaming website" />
            </div>
            ...
            <img src={getGraphic("user_persona_analysis")} className="xl:w-[80%] h-auto" alt="User persona analysis against sitemap structure" />
            <p className="font-serif sm:text-xl lg:text-2xl xl:text-3xl xl:w-[80%]">Validating our high-fidelity designs with defined requirements.</p>
            ...
            <img src={getGraphic("hifis")} className="xl:w-[70%] h-auto" alt="High-fidelity design prototypes for Gator Gaming website" />
          </div>
        </div>
      </section>
      <section id="REFLECTION" className="scroll-mt-15" ref={el => {
        ...
        <div className="flex flex-col gap-3 md:gap-5">
          <p className="mt-8 lg:mt-14 text-xs sm:text-sm">REFLECTION</p>
          <div className="flex flex-col gap-6">
            <img src={getGraphic("reflections")} className="xl:w-[80%] h-auto" alt="Individual reflections"/>
            <img src={getGraphic("group_reflections")} className="xl:w-[75%] h-auto" alt="Group reflections"/>
          </div>
        </div>
      </section>
    </div>
