    ...
    <section className='flex flex-col gap-8 lg:gap-16 scroll-mt-30 md:scroll-mt-40'>
      <div className='subsectionContainer w-[90%] flex flex-col sm:flex-row gap-4 sm:gap-24 md:gap-32 lg:gap-48 2xl:gap-60 justify-between lg:justify-center'>
        ...
        <div className='flex flex-col gap-4'>
          ...
          <p className='font-sans text-sm lg:text-base text-gray-500 w-full 2xl:max-w-[90%]'>
      ...
      <div className='grid grid-cols-1 sm:grid-cols-10 gap-2 md:gap-4 lg:gap-6 w-full items-start'>
        <figure className="sm:col-span-7 flex flex-col gap-2">
          <img
            src="https://cdn.lucasmcallister.com/trajectory/calendar_example.png" 
        ...
        <img 
          src="https://cdn.lucasmcallister.com/trajectory/paper_planning.webp" 
          className="sm:col-span-3 w-full h-auto object-contain"
      ...
      <div className='grid grid-cols-1 sm:grid-cols-2 gap-2 md:gap-4 lg:gap-8 w-full mx-auto items-start'>
        <div className='flex flex-col items-start gap-2'>
          <video src='https://cdn.lucasmcallister.com/trajectory/log_scale_video.mp4' className='block w-full h-auto' autoPlay muted loop playsInline alt='Timeline gap visualization using logarithmic spacing'/>
        ...
        <video src='https://cdn.lucasmcallister.com/trajectory/gap_ui.mp4' className='block w-full h-auto' autoPlay muted loop playsInline alt='Trajectory timeline showing generated gaps between travel events'/>
      </div>
      <div className='grid grid-cols-1 sm:grid-cols-2 gap-2 md:gap-4 lg:gap-8 w-full mx-auto items-start lg:-mt-10'>
        <img src='https://cdn.lucasmcallister.com/trajectory/grouping_graphic.avif' className='block w-full h-auto' alt='Event grouping concept graphic for one trip leg'
        />
        <div className='flex flex-col items-start gap-2'>
          <video src='https://cdn.lucasmcallister.com/trajectory/grouping_live.mp4' className='block w-full h-auto' autoPlay muted loop playsInline alt='Live demo of grouped events in the timeline'/>
          <p className='font-semibold text-xs lg:text-sm w-full'>
            Event Grouping
          </p>
          <p className='text-xs lg:text-sm text-gray-500 w-full -mt-2'>
          ...
          <div className='researchList flex flex-col gap-15 mt-10 lg:mt-15'>
            <div className='researchGroup flex flex-col gap-5'>
              ...
              <div className="w-full xl:max-w-[65rem] bg-gray-100 dark:bg-gray-800 border border-gray-300 dark:border-gray-700 rounded p-3 flex flex-col gap-2">
                ...
                <p className="text-sm text-gray-500 dark:text-gray-300">The catalyst for this project came from my own observations of how my family plans and keeps records of trip information and structure. I noticed that planning and organizing a trip often consisted of dozens of scrambled browser tabs, handwritten notes, and once everything was sorted, an unwieldy and clunky stack of papers with reservations, check-in information, flight boarding passes, train tickets, and everything in between.</p>
              </div>
              <div className="w-full xl:max-w-[65rem] bg-gray-100 dark:bg-gray-800 border border-gray-300 dark:border-gray-700 rounded p-4 flex flex-col gap-2">
                ...
                <p className="text-sm text-gray-500 dark:text-gray-300">Tourism research has shown that travelers do not often plan and rigidly execute on an itinerary, and increasingly with the nature of constant internet access do travelers evaluate and change their plans continually. Emphasizing gaps in a user's trip worked to capture these moments of spontaneity and make them part of the planning experience while also reducing unwanted gaps by surfacing them, like those resulting from late check-ins.</p>
              ...
              <div className="w-full xl:max-w-[65rem] bg-gray-100 dark:bg-gray-800 border border-gray-300 dark:border-gray-700 rounded p-4 flex flex-col gap-2">
                ...
                <p className="text-sm text-gray-500 dark:text-gray-300">Research on booking behavior shows that information overload is common and is significantly shaped by the presentation of information, so it was important for my design to present information using low-effort visual cues that rely on instinct (like shorter stays being visually smaller on the timeline) to avoid information overload when planning/assembling a trip.</p>
        ...
        <div className='flex flex-col w-full'>
          <div className='subsectionList flex flex-col gap-12 mt-10 lg:mt-15 w-full'>
            ...
            <div className='listItemGroup flex flex-col gap-5'>
              ...
              <video src='https://cdn.lucasmcallister.com/trajectory/extension_format_animation.mp4' className='block  w-full xl:w-[90%] h-auto shadow-md' autoPlay muted loop playsInline alt='Chrome extension format demonstration for Trajectory'/>
              <p className='text-sm lg:text-base text-gray-500 w-full xl:w-[90%]'>One of the clearest pain points established in travel decision making research is information overload, which, in this case, manifests as comparing stay/flight options across dozens of browser tabs before committing. Ensuring that Trajectory worked against this stress meant that it couldn't live in a separate app the user has to context-switch to; it needed to be present in the browser itself, accessible without disrupting the user's current action. That requirement led to the Chrome extension format. </p>
            </div>
          ...
          <div className='flex flex-col w-full gap-6 lg:gap-16 xl:gap-24'>
            <div className='grid grid-cols-1 lg:grid-cols-2 mx-auto gap-8'>
              ...
              <div className='reflections flex flex-col gap-4 md:gap-5'>
                ...
                <img src='https://cdn.lucasmcallister.com/trajectory/budgeting_image.avif' className='block w-full h-auto rounded' alt='Trajectory budgeting graphic based on trip legs' />
                <p className='text-sm lg:text-base text-gray-500 w-full md:w-[80%] lg:w-full'>A natural extension to future development is budgeting. Since the content script that the autofill pipeline uses already parses price information from pages it uses to extract place and date data, implementing cost data would require no new technical capability. And since prices can be attributed to each user event this way, they could be surfaced as a color-coded chart representing each trip leg in addition to a simple running count.</p>
              </div>
            </div>
            <div className='reflections flex flex-col gap-4 md:gap-5'>
              <div className='flex gap-4 items-center'>
