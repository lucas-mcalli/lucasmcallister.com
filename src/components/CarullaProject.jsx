...
export default function CarullaProject({getGraphic}) {
  ...
  return (
    ...
    <section className='flex flex-col gap-8 lg:gap-16 scroll-mt-25 lg:scroll-mt-15'>
      <img src="https://cdn.lucasmcallister.com/carulla/carulla_cooking_mockup.webp" className="h-auto" alt="Image of cooking mockup" />
      <div className='subsectionContainer flex flex-col sm:flex-row gap-4 sm:gap-24 md:gap-32 lg:gap-48 2xl:gap-60 justify-between lg:justify-start'>
        ...
        <div className='flex flex-col gap-4'>
          ...
          <p className='font-sans text-sm lg:text-base text-gray-500 w-full 2xl:max-w-[80%]'>
      ...
      <div className='w-full flex gap-6 lg:gap-12 xl:gap-24 justify-center py-5'>
        <img src="https://cdn.lucasmcallister.com/carulla/shipt_sample.webp" className="w-40 md:w-60 xl:w-72" alt="Shipt screenshot illustrating the current standard" />
        <img src="https://cdn.lucasmcallister.com/carulla/gopuff_sample.webp" className=" w-40 md:w-60 xl:w-72" alt="Gopuff screenshot illustrating the current standard" />
        <img src="https://cdn.lucasmcallister.com/carulla/instacart_sample.webp" className="hidden md:block w-50 md:w-60 xl:w-72" alt="Instacart screenshot illustrating the current standard" />
      </div>
      ...
      <div className='grid grid-cols-1 sm:grid-cols-2 gap-2 md:gap-4 lg:gap-8 w-full mx-auto items-start'>
        <div className='flex flex-col items-start gap-2'>
          <video src='https://cdn.lucasmcallister.com/carulla/nutrition_breakdown_closeup.mp4' className='block w-full h-auto' autoPlay muted loop playsInline alt='Nutrition score and breakdown demonstration'/>
        ...
        <img src='https://cdn.lucasmcallister.com/carulla/items_sample.avif' className='block w-full h-auto' alt='Image of items with nutrition scores in cart'/>
      </div>
      <div className='grid grid-cols-1 sm:grid-cols-2 gap-2 md:gap-4 lg:gap-8 w-full mx-auto items-start lg:-mt-10'>
        <img src='https://cdn.lucasmcallister.com/carulla/suggested_recipes.avif' className='block w-full h-auto' alt='Image of suggested recipes'
        />
        <div className='flex flex-col items-start gap-2'>
          <video src='https://cdn.lucasmcallister.com/carulla/Recipe.mp4' className='block w-full h-auto' autoPlay muted loop playsInline alt='Recipe page demonstration'/>
          <p className='font-semibold text-xs lg:text-sm w-full'>
      ...
      <div className='flex flex-col items-start gap-2'>
        <img src='https://cdn.lucasmcallister.com/carulla/filters_graphic.avif' className='block w-full h-auto lg:-mt-10' alt='Image of items with nutrition scores in cart'/>
        <p className='font-semibold text-xs lg:text-sm w-full'>
          ...
          <div className='researchList flex flex-col gap-15 mt-10 lg:mt-15'>
            <div className='researchGroup flex flex-col gap-5'>
              ...
              <div className="w-full xl:max-w-[65rem] bg-gray-100 dark:bg-gray-800 border border-gray-300 dark:border-gray-700 rounded p-4 flex flex-col gap-2">
                ...
                <p className="text-sm text-gray-500 dark:text-gray-300">50% of respondents indicated that they regularly shop for multiple people, and 31% cite coordination with others as a point of stress in their experience. Adding support for household shopping means providing visibility into what others are adding, and confidence that the final cart suits everyone.</p>
              </div>
              <div className="w-full xl:max-w-[65rem] bg-gray-100 dark:bg-gray-800 border border-gray-300 dark:border-gray-700 rounded p-4 flex flex-col gap-2">
                <h5 className="font-semibold text-sm lg:text-base">Savings emphasis</h5>
                <p className="text-sm text-gray-500 dark:text-gray-300">50% of respondents cited budget constraints as a source of difficulty, and 46% plan their shopping around deals and sales entirely. A successful design gives these users a way to find the best value and make it present throughout their experience.</p>
              </div>
            </div>
            <div className='researchGroup flex flex-col gap-5'>
              <div className='flex gap-4 items-center'>
              ...
              <div className='personas flex flex-col gap-8 mt-3'>
                <div className='flex gap-4 items-start'>
                  <img src='https://cdn.lucasmcallister.com/carulla/naomi.avif' className='lg:w-20 lg:h-20 w-16 h-16 shrink-0 rounded-full object-cover object-top' alt='Naomi Abrams' />
                  <div className='flex flex-col gap-1'>
                    <p className='font-semibold text-xs lg:text-sm'>Naomi Abrams</p>
                    <p className='text-sm text-gray-500 w-full md:w-[80%] 2xl:w-[55%]'>Naomi's strict gluten free dietary restrictions and packed schedule shaped the filtering system and nutrition score, as she needed to know at a glance whether a product would work for her.</p>
                  </div>
                </div>
                <div className='flex gap-4 items-start'>
                  <img src='https://cdn.lucasmcallister.com/carulla/sergio.avif' className='lg:w-20 lg:h-20 w-16 h-16 shrink-0 rounded-full object-cover' alt='Sergio José Suarez' />
                  <div className='flex flex-col gap-1'>
                    <p className='font-semibold text-xs lg:text-sm'>Sergio José Suarez</p>
                    <p className='text-sm text-gray-500 w-full md:w-[80%] 2xl:w-[55%]'>Sergio's experience shopping for a large family and concern for what his kids eat made the case for collaborative carts and nutritional transparency at the cart-level, ensuring the household's order is accounted for nutritionally and logistically.</p>
                  </div>
                </div>
                <div className='flex gap-4 items-start'>
                  <img src='https://cdn.lucasmcallister.com/carulla/haoran.avif' className='lg:w-20 lg:h-20 w-16 h-16 shrink-0 rounded-full object-cover' alt='Haoran Liu' />
                  <div className='flex flex-col gap-1'>
                    <p className='font-semibold text-xs lg:text-sm'>Haoran Liu</p>
                    <p className='text-sm text-gray-500 w-full md:w-[80%] 2xl:w-[55%]'>As a college student shopping after the gym, Haoran's focus on budget and macros highlighted the tension between eating well and spending carefully. His persona pushed for savings visibility and nutritional specificity to coexist.</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className='flex flex-col w-full'>
          <div className='subsectionList flex flex-col gap-12 mt-10 lg:mt-15 w-full'>
            ...
            <div className='listItemGroup flex flex-col gap-5'>
              ...
              <img src='https://cdn.lucasmcallister.com/carulla/collaboration_progression.avif' className='block w-full h-auto rounded' alt='Collaboration progress graphic' />
              <p className='text-sm lg:text-base text-gray-500 w-full'>Collaboration was originally tucked into the cart as an icon in the header, which proved easy to miss and unintuitive. Moving it to the home screen's profile avatar was a natural way to make shared shopping visible throughout, making it part of the experience from the start, rather than something configured mid-order.</p>
            </div>
          </div>
        </div>
      </section>
          ...
          <div className='subsectionList flex flex-col gap-12 mt-8 lg:mt-15 w-full'>
            ...
            <div className='listItemGroup flex flex-col gap-5'>
              ...
              <div className='grid grid-cols-1 lg:grid-cols-2 gap-4 w-full'>
                <img src='https://cdn.lucasmcallister.com/carulla/design_system.avif' className='block w-full h-auto rounded' alt='Design system graphic' />
                <img src='https://cdn.lucasmcallister.com/carulla/components.avif' className='block w-full h-auto rounded' alt='Original components graphic' />
              </div>
              <p className='text-sm lg:text-base text-gray-500 w-full'>Adapted from shadcn/ui, the design system featured custom typography, color styles, 16 original components, and variables enabling consistent iteration of new designs across every screen.  </p>
            </div>
            ...
            <div className='listItemGroup flex flex-col gap-5'>
              ...
              <div className='flex flex-col gap-4 w-full'>
                <video src='https://cdn.lucasmcallister.com/carulla/carulla_details.mp4' className='block w-full h-auto' autoPlay muted loop playsInline alt='Checkout and arrival experience video'/>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 w-full">
                  <img src='https://cdn.lucasmcallister.com/carulla/filters_detail.avif' className='block w-full h-auto rounded' alt='Image of filters detail'/>
                  <img src='https://cdn.lucasmcallister.com/carulla/confirmation.avif' className='block w-full h-auto rounded' alt='Image of confirmation detail'/>
                </div>
                <img src='https://cdn.lucasmcallister.com/carulla/billboard.avif' className='block w-full h-auto rounded' alt='Billboard mockup graphic' />              
              </div>
            </div>
          </div>
        </section>
