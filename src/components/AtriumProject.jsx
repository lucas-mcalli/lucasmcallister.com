        ...
        <div className="flex flex-col gap-3 lg:gap-5 2xl:gap-7">
          ...
          <div className='flex items-center w-full gap-6 xl:gap-10 xl:w-[80%] 2xl:w-[70%]'>
            ...
            <div className='flex flex-col gap-3 w-[75%]'>
              <p className="font-sans text-xs lg:text-base xl:text-lg">As a front-end developer and designer, my role was scoping the project around our time constraints, building a cohesive brand and visual identity, and designing and implementing screens with reusable components.</p>
            <p className="font-sans text-xs lg:text-base xl:text-lg z-10">Built with <motion.a href="https://nextjs.org/" target="_blank" rel="noopener noreferrer" className="underline pointer-events-auto" whileHover={{ color: '#eec12e' }}>Next.js</motion.a> + <motion.a href="https://react.dev/" target="_blank" rel="noopener noreferrer" className="underline pointer-events-auto" whileHover={{ color: '#eec12e' }}>React</motion.a>, <motion.a href="https://tailwindcss.com/" target="_blank" rel="noopener noreferrer" className="underline pointer-events-auto" whileHover={{ color: '#eec12e' }}>Tailwind</motion.a>, <motion.a href="https://supabase.com/" target="_blank" rel="noopener noreferrer" className="underline pointer-events-auto" whileHover={{ color: '#eec12e' }}>Supabase</motion.a>, and hosted with <motion.a href="https://vercel.com/" target="_blank" rel="noopener noreferrer" className="underline pointer-events-auto" whileHover={{ color: '#eec12e' }}>Vercel</motion.a>.</p>
            </div>
          </div>
        </div>
      </section>
