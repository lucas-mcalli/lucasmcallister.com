    ...
    <>
        ...
        <div className="flex flex-col gap-3 lg:gap-5 2xl:gap-7">
          ...
          <div className='flex items-center w-full gap-6 xl:gap-10 xl:w-[80%] 2xl:w-[70%]'>
            ...
            <div className='flex flex-col gap-3 w-[75%]'>
              <p className="font-sans text-sm lg:text-base xl:text-lg">As a front-end developer and designer, my role was scoping the project around our time constraints, building a cohesive brand and visual identity, and designing and implementing screens with reusable components.</p>
            <p className="font-sans text-sm lg:text-base xl:text-lg z-10">Built with <motion.a href="https://nextjs.org/" target="_blank" rel="noopener noreferrer" className="underline pointer-events-auto" whileHover={{ color: '#eec12e' }}>Next.js</motion.a> + <motion.a href="https://react.dev/" target="_blank" rel="noopener noreferrer" className="underline pointer-events-auto" whileHover={{ color: '#eec12e' }}>React</motion.a>, <motion.a href="https://tailwindcss.com/" target="_blank" rel="noopener noreferrer" className="underline pointer-events-auto" whileHover={{ color: '#eec12e' }}>Tailwind</motion.a>, <motion.a href="https://supabase.com/" target="_blank" rel="noopener noreferrer" className="underline pointer-events-auto" whileHover={{ color: '#eec12e' }}>Supabase</motion.a>, and hosted with <motion.a href="https://vercel.com/" target="_blank" rel="noopener noreferrer" className="underline pointer-events-auto" whileHover={{ color: '#eec12e' }}>Vercel</motion.a>.</p>
            </div>
          </div>
        </div>
      </section>
      <section id="PROBLEM" className="scroll-mt-15" ref={el => {
        ...
        <div className="flex flex-col gap-3 lg:gap-5 2xl:gap-7">
          ...
          <img src="https://cdn.lucasmcallister.com/atrium/atrium_demo.avif" className="xl:w-[80%] 2xl:w-[70%] h-auto" alt="Image showing desktop frame" />
          <p className=" font-sans text-sm xl:w-[80%] 2xl:w-[70%] lg:text-base xl:text-lg">College students are pulled in more directions than ever: juggling classes, jobs, and a roster of clubs they care about. But between GroupMe chats, Google Drive folders, and QR codes flashed at GBMs, keeping up starts to become costly. There's no central place to track what orgs they're a part of, and meetings meant to bring them community end up demanding more attention and focus than they can spare.</p>
          <p className=" font-sans text-sm xl:w-[80%] 2xl:w-[70%] lg:text-base xl:text-lg">For club owners, there's often no reliable way to track who keeps showing up, no mechanism to reward committed members, and no easy way to present resources without interrupting the flow of a meeting. The result: a disconnect between the community they work tirelessly to build and the data that backs it.</p>
        </div>
      </section>
      <section id="PROCESS" className="scroll-mt-15" ref={el => {
        ...
        <div className="flex flex-col gap-3 lg:gap-5 2xl:gap-7" >
          <div className="flex flex-col gap-2 2xl:gap-3">
            <p className=" mt-8 lg:mt-14 2xl:mt-20 text-xs sm:text-sm font-departure">PROCESS</p>
          ...
          <div className="flex flex-col gap-6 2xl:gap-8">
            ...
            <img src={getGraphic("atrium_brand")} className="lg:mt-6 xl:w-[75%] 2xl:w-[60%] h-auto" alt="Atrium's core brand colors and typography" />
          </div>
        </div>
      </section>
          ...
          <div className='lg:flex items-center w-full lg:w-[80%]'>
            ...
            <motion.a href="https://atrium.ink" target="_blank" rel="noopener noreferrer" className="inline-flex pointer-events-auto flex-shrink-0 relative group">
              <div className="flex flex-col items-center gap-2">
                <motion.div whileHover={{scale: 1.05}} className="hidden lg:flex items-center gap-4 px-5 py-3 rounded-lg border-2 border-gray-200 dark:border-white relative overflow-hidden translate-x-[55%] -translate-y-10 xl:-translate-x-[55%]">
                  <img src="https://cdn.lucasmcallister.com/atrium/ATRIUM_LOGO.png" className="w-12 h-12 relative z-10" alt="Atrium logo" />
                  <span className="text-xl font-grotesk whitespace-nowrap relative z-10">atrium.ink</span>
                </motion.div>
                <p className="hidden lg:block text-xs font-sans text-center translate-x-[68%] -translate-y-10 xl:-translate-x-[68%]">Check out our desktop demo!</p>
              </div>
            </motion.a>
          </div>
        </div>
