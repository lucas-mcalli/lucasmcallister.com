...
const Waves = ({
  ...
  useEffect(() => {
    ...
    function tick(t) {
      ...
      document.documentElement.style.setProperty('--cursor-x', `${mouse.sx}px`);
      document.documentElement.style.setProperty('--cursor-y', `${mouse.sy}px`);
  ...
  return (
    <>
      ...
      {createPortal(
        <div
          className="hidden fixed top-0 left-0 bg-[#111111] dark:bg-[#ffffff] rounded-full w-[0.5rem] h-[0.5rem] z-[9999] pointer-events-none" // cursor dot (hidden)
          style={{
